import styles from '@common/styles/env.module.css'

const Code = (p: any) => <code className={styles.inlineCode} {...p} />
...
const IndexPage = () => (
  <div className={styles.container}>
    <div className={styles.card}>
      ...
      <p>
        In general only <Code>.env.local</Code> or <Code>.env</Code> are needed for this, but the table also features
        the usage of <Code>.env.development</Code> and <Code>.env.production</Code>.
      </p>
      ...
      <p>
        <Code>.env.local</Code> is not added by the example, because it must be ignored by git, but you can add it
        manually:
      </p>
      <pre>
      ...
      <p>
        Similarly, variables in <Code>.env.development</Code> won&apos;t be available if the app is running on
        production:
      </p>
      <pre>
